...
export default function Saque2() {
  return (
    ...
    <div className="m-0 rounded p-0 bg-[#fff]">
      ...
      <div className="flex items-center justify-start">
            ...
            <div>
              ...
              <h3 className='text-[#000] font-bold text-2xl'>Qual saldo gostaria de solicitar saque?</h3>
              <br />
              ...
              <form action="" className='pt-4'>
                <div className="row">
                  ...
                  <input placeholder='Valor' className='w-[300px] p-2 my-2 rounded border-0 outline-none text-[#646464] border-none bg-[#D9D9D9]' type="text" />
                 
                  </div>

                  <div className="col-lg-6">
                    <input placeholder='Confirmar valor' className='w-[300px] my-2 p-2 rounded border-0 outline-none text-[#646464] border-none bg-[#D9D9D9]' type="text" />
                  </div>
                  <div className="col-lg-6">
                  <input placeholder='Senha para transação' className='w-[300px] my-2 p-2 rounded border-0 outline-none text-[#646464] border-none bg-[#D9D9D9]' type="text" />
                  ...
                  <div className="col-lg-6">
                    ...
                    <div>
                    <button className='bg-[#137CF7] p-2 rounded font-bold'>Solicitar saque</button>
                    </div>
